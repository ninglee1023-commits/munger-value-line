const CATALOG = [
  ...
  {
    id: "cki", file: "cki.json", name: "長江基建集團", ticker: "1038.HK / LSE: CKI",
    date: "2026-09-14", sector: "全球基建與公用事業", verdict: "高質量收息觀察名單", valuation: "約 3.9% 股息率 / 20.2× 2025 PE",
    conclusion: "29年連續增息是真紀錄；但近十年DPS增長主要靠派息率由約59%升至80%，現價已為安全性支付溢價。",
    lead: "2016–2025每股股息由HK$2.26升至HK$2.61、年年增加；同期EPS由HK$3.82降至HK$3.28，2025 FFO仍可1.29倍覆蓋現金派息。",
    metrics: [["連續增息","29 年"],["十年 DPS CAGR","約 1.6%"],["2025 FFO覆蓋","1.29×"],["2026 H1淨現金","HK$33.9B"]],
    visuals: [
      {kind:"line",title:"十個完整年度每股股息",note:"港元；2016–2025九段年度全部增長。",labels:["2016","2017","2018","2019","2020","2021","2022","2023","2024","2025"],series:[{name:"DPS",values:[2.26,2.38,2.43,2.46,2.47,2.50,2.53,2.56,2.58,2.61]}]},
      {kind:"line",title:"每股盈利沒有同步複利",note:"港元；股息平滑，但EPS於2020年下台階。",labels:["2016","2017","2018","2019","2020","2021","2022","2023","2024","2025"],series:[{name:"EPS",values:[3.82,4.07,4.14,4.17,2.91,2.98,3.08,3.19,3.22,3.28]},{name:"DPS",values:[2.26,2.38,2.43,2.46,2.47,2.50,2.53,2.56,2.58,2.61]}]},
      {kind:"line",title:"派息率在盈利下台階後抬升",note:"現金派息總額÷歸母盈利；百分比。",suffix:"%",labels:["2016","2017","2018","2019","2020","2021","2022","2023","2024","2025"],series:[{name:"派息率",values:[59.1,58.5,58.6,59.0,85.0,83.8,82.3,80.4,80.1,79.6]}]},
      {kind:"hbar",title:"2025盈利貢獻結構",note:"未分配項目前；Power Assets與三類基建約各占四分之一。",suffix:"%",labels:["受監管電力配網","電能實業","其他受監管公用事業","合約基建","其他業務"],values:[30,23,23,23,1]}
    ]
  },
  {
  ...
  },
  {
    ...
    conclusion: "加盟网络的单位价差与密度改善正在兑现；真正问题是反内卷与丹鸟并表后，利润能否在价格恢复终止后保持。",
    lead: "2026 H1收入324.9亿元、归母净利10.35亿元、经营现金流20.64亿元；快递服务毛利率按披露数据计算约6.97%。",
    metrics: [["2026 H1收入","324.91亿元"],["2026 H1归母净利","10.35亿元"],["快递服务毛利率","约6.97%"],["市场份额","14.24%"]],
    visuals: [
      {kind:"line",title:"十年规模与盈利修复",note:"人民币亿元；2016–2025完整年度，2026 H1不混入全年序列。",labels:["2016","2017","2018","2019","2020","2021","2022","2023","2024","2025"],series:[{name:"收入",values:[98.81,126.57,170.13,230.89,215.66,252.55,336.71,409.24,471.69,555.86]},{name:"归母净利润",values:[12.62,14.88,20.49,14.08,0.36,-9.09,2.88,3.41,10.4,13.69]}]},
      {kind:"bar",title:"毛利率仍薄，但正在修复",note:"百分比；2025 H1为快递服务毛利率，2026 H1同时列服务与总毛利率。",suffix:"%",labels:["2025 H1服务","2026 H1服务","2026 H1总计"],values:[4.89,6.97,7.54]},
      {kind:"bar",title:"2026 H1增长质量",note:"同比百分比；利润和现金流增速明显快于件量。",suffix:"%",labels:["收入","件量","归母净利","经营现金流"],values:[29.83,15.81,128.31,178.85]},
      {kind:"bar",title:"单票经济：薄价差乘大规模",note:"人民币／件；收入为披露值，其余为本文按半年报计算值。",labels:["单票收入","快递毛利","归母利润","经营现金流"],values:[2.24,0.156,0.072,0.144]}
    ],
    sources: [
      ["申通快递2026年半年度报告摘要","https://static.cninfo.com.cn/finalpage/2026-08-28/1225517933.PDF"],
